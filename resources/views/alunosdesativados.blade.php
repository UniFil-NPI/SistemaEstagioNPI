...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <a href="/admin/alunosadmin" class="btn-back">
            ...
            <table class="table mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-center"><span>Etapa que estava</span></th>
                        <th class="text-center"><span>Status que estava</span></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <span class="label label-default">Estava Normal</span>
                            @else
                            <span class="label label-default">Estava Pendente</span>
                            @endif
                        </td>
                        <td class="text-center">
                            {{ $aluno->email_aluno }}
                        ...
                        <td class="text-center">
                            <span class="label label-default">
                                <a href="/admin/alunosdesativados/{{$aluno->email_aluno}}" class="btn btn-sm btn-primary">Reativar</a>
                            </span>
                        </td>
                    </tr>
                    @endforeach
