...
<html lang="en">
    <head>
        ...
        */
        ...
        min-height: 35rem;
        padding: 15rem 0;
        background: linear-gradient(to bottom, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.7) 75%, #000 100%), url("{{ asset('images/landing-bg.jpg') }}");
        background-position: center;
        background-repeat: no-repeat;
        ...
        .signup-section {
        padding: 10rem 0;
        background: linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.5) 75%, #000 100%), url("{{ asset('images/landing-bg.jpg') }}");
        background-position: center;
        background-repeat: no-repeat;
        background-attachment: scroll;
        background-size: cover;
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Sistema de Estágio</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Seja bem vindo ao Sistema de Estagio da UniFil</h2>
                        <a class="btn btn-primary" href="/auth/google">Entrar</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="text-white mb-4">Como usar esse sistema?</h2>
                        <br>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/1FANIjfPbfo?si=BPbg7ykrPIjv16cN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>                            
                        </iframe>
                        <br><br><br><br>
                    </div>
                </div>
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container px-4 px-lg-5">Copyright &copy; NPI 2024</div></footer>
        <!-- Bootstrap core JS-->
