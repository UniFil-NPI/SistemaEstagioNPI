                ...
                <tbody>
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td>
                                <a href="/admin/professoresadmin/{{ $user->isadmin ? 'tirarprivilegios' : 'darprivilegios' }}/{{$user->email}}" class="btn btn-sm btn-success">
                                    {{ $user->isadmin ? 'Tirar Privilégios' : 'Dar Privilégios' }}
                                </a>
                                <a href="/admin/professoresadmin/desativar/{{$user->email}}" class="btn btn-sm btn-danger">Desativar</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
